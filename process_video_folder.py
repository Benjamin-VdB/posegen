...
def proc_vid_folder(folder, model_resolution='656x368', model='cmu', display=False, flip=False):
    ...
    for filename in os.listdir(folder):
        if filename.endswith(".mp4") and not os.path.isfile(folder + '/vid_out/' + filename + '_out.avi') and not os.path.isfile(folder + '/vid_out/unvalid/' + filename + '_out.avi'): 
...
proc_vid_folder(folder='./#poletricks', model='cmu')